...
namespace Microsoft.Samples.Kinect.BodyBasics
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        /// 
        private string claveU2;
       // private bool sesion;

        
        public MainWindow()
        {
            claveU2 = System.Guid.NewGuid().ToString().Replace("-", "").ToUpper();
                    ...
                    foreach (Body body in this.bodies)
                    {
                        ...
                        if (body.IsTracked)
                        {
                           ...
                           label.Content = String.Format("Body: \n {0}  \n", json);
                            ...
                            command.CommandText = "INSERT INTO tbody2 (lectura,claveU) VALUES ('" + json + "', '"+claveU2+"')";
