...
namespace Microsoft.Samples.Kinect.BodyBasics
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        {
            //generando nuevo ID.
          globalId = System.Guid.NewGuid().ToString().Replace("-", "").ToUpper();
                ...
                using (DrawingContext dc = this.drawingGroup.Open())
                {
                    ...
                    foreach (Body body in this.bodies)
                    {
                        ...
                        if (body.IsTracked)
                        {
                            ...
                            command.CommandText = "INSERT INTO tbody2 (lectura) VALUES ('" + json + "')";
        ...
        {
            //restart your application on a button click:
